<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="/images/logo-removebg-preview.png" alt="Logo" class="h-14 w-auto max-w-[300px]">
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Minhas Redações - responsivo -->
            <x-responsive-nav-link :href="route('redacoes.index')" :active="request()->routeIs('redacoes.index')">
                <img src="/icons/contract.png" alt="Ícone de Minhas Redações" class="h-6 w-6 inline-block mr-1" />
                {{ __('Minhas Redações') }}
            </x-responsive-nav-link>
        </div>
