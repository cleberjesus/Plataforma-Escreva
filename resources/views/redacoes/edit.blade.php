            ...
            <div class="p-6 sm:p-10">
                ...
                <form action="{{ route('redacoes.update', $redacao->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div id="texto_redacao_div">
                        ...
                        <textarea id="texto_redacao" name="texto_redacao" rows="5" class="w-full p-3 border border-gray-300 rounded-lg">{{ old('texto_redacao', $redacao->texto_redacao) }}</textarea>
                    </div>
