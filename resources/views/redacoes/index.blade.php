...
<div class="container mt-5">
    <div class="card shadow-lg p-4 rounded-4">
        <h2 class="mb-4 text-center fw-bold text-white">Minhas Redações</h2>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card shadow-lg p-3 rounded-4">
                            <div class="card-body">
                                ...
                                <p class="text-muted text-white">Enviado em: {{ \Carbon\Carbon::parse($redacao->created_at)->format('d/m/Y H:i') }}</p>
...
<style>
    /* Adicionando o estilo para a cor branca no texto */
    .text-white {
