...
class SimuladoCoringaController extends Controller
{
    ...
    {
        $redacoes = $this->getRedacoesCoringa();

        // Escolhe uma chave aleatória do array
        $chaveAleatoria = array_rand($redacoes);
        $redacaoEscolhida = $redacoes[$chaveAleatoria];

        // Seleciona um texto motivador aleatório
        $textoMotivador = $redacaoEscolhida['textos'][array_rand($redacaoEscolhida['textos'])];

        return response()->json([
            'tema' => $redacaoEscolhida['titulo'],
            'textoMotivador' => $textoMotivador,
            'imagem' => $redacaoEscolhida['imagem'],
            'charges' => $redacaoEscolhida['charges']
        ]);
    }

    private function getRedacoesCoringa()
    {
        // Reutiliza os dados do getTemas()
...
Disponível em: https://repositorio.ipea.gov.br/handle/11058/7412 (adaptado)."
                ...
                'charges' => [
                    'charges/invisibilidade-do-trabalho-de-cuidado-da-mulher.png'
                ]
            ],
            'viver-em-rede' => [
...
http://educacao.globo.com/portugues/assunto/redacao/enem-2011-tema-da-redacao.html",
                    "Texto 2:
...
Disponível em: http://www.museudaimigracao.org.br. Acesso em: 19 jul. 2012 (adaptado).",
                    "Texto 2: Acre sofre com invasão de imigrantes do Haiti
...
Disponível em: www.operacaoleisecarj.rj.gov.br. Acesso em: 20 jun. 2013 (adaptado)."
            ...
            'violencia-mulher' => [
                ...
                'imagem' => 'violencia-contra-mulher.jpg',
                'textos' => [
                    "Texto 1:
...
WALSELFISZ, J. J. Mapa da Violência 2012. Atualização: Homicídio de mulheres no Brasil. Disponível em: www.mapadaviolencia.org.br. Acesso em: 8 jun. 2015."
            ...
            'intolerancia-religiosa' => [
                ...
                'imagem' => 'intolerancia-religiosa.jpg',
                'textos' => [
                    "Texto 1:
...
STECK, J. Intolerância religiosa é crime de ódio e fere a dignidade. Jornal do Senado. Acesso em: 21 maio 2016 (fragmento)."
            ...
            'formacao-educacional-surdos' => [
                ...
                'imagem' => 'formacao-educacional-surdos-brasil.jpg',
                'textos' => [
                    "Texto 1:
CAPÍTULO IV
DO DIREITO À EDUCAÇÃO
Art. 27. A educação constitui direito da pessoa com deficiência, assegurados sistema de educação inclusivo em todos os níveis e aprendizado ao longo de toda a vida, de forma a alcançar o máximo desenvolvimento possível de seus talentos e habilidades físicas, sensoriais, intelectuais e sociais, segundo suas características, interesses e necessidades de aprendizagem.
...
Disponível em: www.brasil.gov.br. Acesso em: 9 jun. 2017 (adaptado)."
            ...
            'trabalho-e-dignidade' => [
                ...
                'imagem' => 'trabalho-construcao-dignidade-humana.jpeg',
                'textos' => [
                    "Texto 1: 
